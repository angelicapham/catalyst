  ...
  const PageOne = ({moodList, updateMood }) => {
    return (
      <div>
        ...
        <div class="grid grid-rows-2 grid-cols-5 drop-shadow-md">

          <div class="column-5 mood-1 rounded-3xl hover:brightness-90 ml-7">
            <h2 class="image-text hover:brightness-90">
              <button onClick={() => updateMood("Happy")}>Happy</button>
            </h2>
          </div>

          <div class="column-5 mood-2 rounded-3xl hover:brightness-90">
            <h2 class="image-text hover:brightness-90">
          ...
          <div class="column-5 mood-3 rounded-3xl hover:brightness-90">
            <h2 class="image-text hover:brightness-90">
          ...
          <div class="column-5 mood-4 rounded-3xl hover:brightness-90">
            <h2 class="image-text hover:brightness-90">
          ...
          <div class="column-5 mood-5 rounded-3xl hover:brightness-90 mr-7">
            <h2 class="image-text hover:brightness-90">
          ...
          <div class="column-5 mood-6 rounded-3xl hover:brightness-90 ml-7">
            <h2 class="image-text hover:brightness-90">
          ...
          <div class="column-5 mood-7 rounded-3xl hover:brightness-90">
            <h2 class="image-text hover:brightness-90">
          ...
          <div class="column-5 mood-8 rounded-3xl hover:brightness-90">
            <h2 class="image-text hover:brightness-90">
          ...
          <div class="column-5 mood-9 rounded-3xl hover:brightness-90">
            <h2 class="image-text hover:brightness-90">
          ...
          <div class="column-5 mood-10 rounded-3xl hover:brightness-90 mr-7">
            <h2 class="image-text hover:brightness-90">
  ...
  const PageTwo = ({ mood, resetMood }) => {
    return (
      <div>
        ...
        <div class="grid grid-rows-1 grid-cols-2 drop-shadow-md">

          <div class="button rounded-3xl hover:brightness-90">
            <h2 class="text-center mb-5 text-[#333861] hover:brightness-200">
              <button onClick={resetMood}>Back</button>
            </h2>
          </div>

           <div class="button rounded-3xl hover:brightness-90">
            <h2 class="text-center mb-5 text-[#543361] hover:brightness-200">
